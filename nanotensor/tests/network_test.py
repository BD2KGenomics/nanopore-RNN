...
class NetworkTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.labels_batch = np.array([[[1,2,3,4,1,2,3,4], [5,6,7,8,5,6,7,8], [9,10,11,12,9,10,11,12]],
                                     [[13,14,15,16,13,14,15,16], [17,18,19,20,17,18,19,20], [21,22,23,24,21,22,23,24]]]).astype(np.float32)
        ...
        cls.model = BuildGraph(n_input = cls.n_input, n_classes = cls.n_classes,learning_rate = 0.001, n_steps= 3, forget_bias=5.0, x=cls.images_batch, y=cls.labels_batch,
