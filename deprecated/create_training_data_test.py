...
import unittest
import shutil
from nanotensor.deprecated.create_training_data import CommandLine, get_arguments, create_training_data_args, \
...
#
#         cls.log_file = create_log_file(cls.test_files, cls.old_log_file, new_log_path)
